namespace LAB06
{
    public partial class Form1 : Form
    {
        ...
        private void InitUI()
        {
            // TODO: 2.1 Подписать главное окно своим ФИО
            this.Text = "Калькулятор - Фронская Полина Петровна."; 

            // TODO: 2.2 Задать размер окна = 800x600
            this.Size = new Size(800, 600);

            // TODO: 2.3 Задать цвет фона Color.FromArgb(30, 30, 30)
